      ...
      <section className="py-6 px-4 border-b border-gray-200">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-sm text-gray-700 mb-3">
            <strong>Health insurance</strong> costs increased as the Select Board voted in November to switch employees from a high-deductible plan ($6,000 individual / $12,000 family) to an MVP Gold plan with lower deductibles, plus adding dental and vision coverage for the first time. Vermont small group health insurance premiums continue to rise annually—MVP plans increased 2.5% and Blue Cross plans 4.4% on average for 2026—and the town&apos;s previous high-deductible approach was no longer sustainable.
          </p>
          <p className="text-sm text-gray-700 mb-3">
          ...
          <p className="text-sm text-gray-700">
            The Select Board considered two approaches to address the town&apos;s growing administrative workload: either increase hours for existing employees and find ways to fund additional work from Select Board members, or hire a new <strong>Town Administrator</strong>. The Town Administrator option adds $91K net to the budget—a $73K salary plus $35K in benefits, offset by consolidating existing part-time roles (Selectboard Minute Taker and FEMA coordinator). As shown in the waterfall chart below, the Town Administrator is only about $6K more than the alternative &quot;Office Expansion&quot; approach, while providing dedicated professional capacity for grant writing, municipal compliance, and flood recovery coordination.
          </p>
        </div>
      </section>
